  ...
  return (
    <section id="work" className="flex flex-col min-h-screen">
      <AnimatedHeaderSection
        subTitle={"Where Software Engineering Meets Data Intelligence"}
        title={"Works"}
        text={text}
      ...
      >
        {projects.map((project, index) => (
          ...
          >
            ...
            {/* Description */}
<p className="px-10 mt-3 text-gray-600 md:text-lg">
  {project.description}
</p>
...
<div className="flex gap-4 px-10 mt-4">
  ...
  {project.github && (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="px-4 py-2 border border-black rounded-full hover:bg-black hover:text-white"
    >
      💻 GitHub
    </a>
  )}
